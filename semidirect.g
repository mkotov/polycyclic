...
test_attacks := function(f, public_set_size, private_key_size, test_num)   
    local alice_public_set, bob_public_set, alice_private_key, conjugated_bob_public_set, 
            G, start_time, end_time, i, found_alice_private_key, fba_total_time, lba_total_time;
    G := generate_O_by_U_by_f_with_extra_info(f); 
...
Print("--3--\n");
test_field_based_attack_2(x^2 - x - 1, 20, 5, 100);
test_field_based_attack_2(x^5 - x^3- 1, 20, 5, 100);
test_field_based_attack_2(x^7 - x^3 - 1, 20, 5, 100);
test_field_based_attack_2(x^9 - 7*x^3 - 1, 20, 5, 100);
test_field_based_attack_2(x^11 - x^3 - 1, 20, 5, 100);

Print("--4--\n");
test_field_based_attack_2(x^2 - x - 1, 20, 100, 100);
test_field_based_attack_2(x^5 - x^3- 1, 20, 100, 100);
test_field_based_attack_2(x^7 - x^3 - 1, 20, 100, 100);
test_field_based_attack_2(x^9 - 7*x^3 - 1, 20, 100, 100);
test_field_based_attack_2(x^11 - x^3 - 1, 20, 100, 100);
